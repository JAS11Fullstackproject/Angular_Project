...
public class fileupload {
	...
	public byte[] getPassport_copy() {
		return passport_copy;
	}

	public void setPassport_copy(byte[] passport_copy) {
	...
	public byte[] getAadhar_copy() {
		return aadhar_copy;
	}

	public void setAadhar_copy(byte[] aadhar_copy) {
	...
	public byte[] getDriving_license_copy() {
		return driving_license_copy;
	}

	public void setDriving_license_copy(byte[] driving_license_copy) {
...
//	@Pattern(regexp = "(^$|[0-9]{12})",message ="Please enter a valid aadhar_no")
	...
	public fileupload(String status) {
		super();
		Status = status;
	}

	public fileupload(int id, String first_name, String middle_name, String last_name, Date date_of_birth, String age,
			String gender, String email, String mobile_no, String address, String city, String state, String country,
			String pin_code, String alternate_no, String emergency_no, String blood_group, String passport_no,
			byte[] passport_copy, String aadhar_no, byte[] aadhar_copy, String driving_license,
			byte[] driving_license_copy, Long previous_emp_id, String previous_employer_details, String work_location,
			String marital_status, String language_known, String github_id, String social_media,
			String physically_challenge, String identification_marks) {
		super();
		this.id = id;
		this.first_name = first_name;
		this.middle_name = middle_name;
